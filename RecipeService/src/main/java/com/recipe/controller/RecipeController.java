...
public class RecipeController {
	...
	public Recipe saveRecipe(@Valid @RequestBody Recipe recipe, @RequestHeader("userId")  String id) {
		Long userId = Long.valueOf(id);
		return recipeService.saveRecipe(recipe,userId);
	}
	...
	@GetMapping("/getRecipeByUserId")
	public List<Recipe> fetchRecipeByUserId(@RequestHeader("userId") String id) {
		Long userId = Long.valueOf(id);
	...
	public Recipe getByRecipeId(@PathVariable Long recipeId) {
