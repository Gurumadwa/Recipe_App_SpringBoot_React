...
//    @PostMapping("/login")
//    public String loginUser(@RequestBody UserCredentialsDto user) throws InvalidCredentialsException {
//    	return userService.loginUser(user);
//    }
    
    @PostMapping("/authenticate")
    public String authenticateAndGetToken(@RequestBody UserCredentialsDto user) {
    	...
    	if(authentication.isAuthenticated()) {
    		...
    		return jwtUtils.generateToken(foundUser.getUsername(), foundUser.getUserId(), foundUser.getRole());
