...
//
//	@Pointcut(value = "execution(* com.userservice.*.*.*(..))")
...
//		String className = joinPoint.getTarget().getClass().getSimpleName();
//
//		log.info("Method response: {}.{}() with response: {}", className, methodName,
...
//		Object[] array = joinPoint.getArgs();
//
//		log.error("Exception in {}.{}() with arguments: {}. Exception: {}", className, methodName,
//				mapper.writeValueAsString(array), exception.getMessage(), exception);
//	}
//}
